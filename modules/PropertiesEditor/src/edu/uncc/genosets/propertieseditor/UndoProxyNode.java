...
import edu.uncc.genosets.propertieseditor.UndoProxyNode.ProxyProperty.UndoableEditImpl;
 ...
 * @author aacain
 */
public class UndoProxyNode extends FilterNode {
    ...
    public PropertySet[] getPropertySets() {
        ...
        PropertySet[] sets;
        if (this.getOriginal() instanceof PropertiesEditable) {
            PropertiesEditable e = (PropertiesEditable) this.getOriginal();
            sets = e.getEditablePropertySets();
        } else {
    ...
    static class ProxyProperty<T> extends org.openide.nodes.Node.Property<T> {
        ...
        @NbBundle.Messages({"CANNOT_UNDO=Cannot Undo {0}", "CANNOT_REDO=Cannot Redo {0}"})
        static class UndoableEditImpl<T> implements UndoableEdit {
            ...
            public String getUndoPresentationName() {
                return Bundle.UNDO(prop.getDisplayName());
            }

            @Override
            public String getRedoPresentationName() {
                return Bundle.REDO(prop.getDisplayName());
            }
