...
public class TreeMap extends Display {
    ...
    public static final String TREE_CHI ="data/chi-ontology.xml";
    ...
    private ListQueryBinding depthQ;
    ...
    public TreeMap(Tree t, String label) {
        ...
        Predicate childP = ExpressionParser.predicate("[hasChild] = true");
        depthQ = new ListQueryBinding(vt, "depth", false);


        // ensure that only leaf nodes are interactive
        m_vis.setInteractive(treeNodes, childP, false);
    ...
    public static JComponent demo(String datafile, final String label) {
        ...
        final JComboBox depthList = treemap.getDepthQ().createComboBox();
        ...
        panel.add(depthList, BorderLayout.NORTH);
     ...
     * @return the depthQ
     */
    public ListQueryBinding getDepthQ() {
        return depthQ;
    }

    /**
     * @param depthQ the depthQ to set
     */
    public void setDepthQ(ListQueryBinding depthQ) {
        this.depthQ = depthQ;
    }
    ...
    public static class BorderColorAction extends ColorAction {
        ...
        public int getColor(VisualItem item) {
            ...
            if ( depth < 1 ) {
                ...
                return ColorLib.blue(100);
            }else if(depth < 3){
                return ColorLib.green(100);
            }
            else if ( depth < 4 ) {
    ...
    public static class FillColorAction extends ColorAction {
        ...
        public int getColor(VisualItem item) {
            if ( item instanceof NodeItem ) {
                NodeItem nitem = (NodeItem)item;
                //Change to only include nodes that
