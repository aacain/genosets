...
import edu.uncc.genosets.prefuse.GOSchema;
...
public class RadialGraphView extends Display {
    ...
    public static JPanel demo(String datafile, final String label) {
        ...
        return demo(g, label);*/
        Graph g = new Graph();
        g.addColumn(GOSchema.NAME, String.class);
        //g.addColumn("label", String.class, "hello");
        for ( int i=0; i<3; ++i ) {
            Node n1 = g.addNode();
            n1.setString(GOSchema.NAME, Integer.toString(n1.getRow()));
            Node n2 = g.addNode();
            n2.setString(GOSchema.NAME, Integer.toString(n2.getRow()));
            Node n3 = g.addNode();
            n3.setString(GOSchema.NAME, Integer.toString(n3.getRow()));
            g.addEdge(n1, n2);
            g.addEdge(n1, n3);
            g.addEdge(n2, n3);
        }
